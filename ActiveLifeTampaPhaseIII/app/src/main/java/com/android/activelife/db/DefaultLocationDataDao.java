...
/** 
 * DAO for table "DEFAULT_LOCATION_DATA".
*/
public class DefaultLocationDataDao extends AbstractDao<DefaultLocationData, Long> {

    public static final String TABLENAME = "DEFAULT_LOCATION_DATA";

    /**
     * Properties of entity DefaultLocationData.<br/>
    ...
    public DefaultLocationDataDao(DaoConfig config) {
        super(config);
    }
    
    public DefaultLocationDataDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"DEFAULT_LOCATION_DATA\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"DEFAULT_LOCATION_DATA\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, DefaultLocationData entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, DefaultLocationData entity) {
        stmt.clearBindings();
    ...
    @Override
    public DefaultLocationData readEntity(Cursor cursor, int offset) {
        DefaultLocationData entity = new DefaultLocationData( //
    ...
    @Override
    public void readEntity(Cursor cursor, DefaultLocationData entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(DefaultLocationData entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(DefaultLocationData entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(DefaultLocationData entity) {
